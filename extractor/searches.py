...
def get_videos(service: Resource, max_pages: int, **kwargs):
    final_results = []
...
def search_videos_comments_by_keyword(service: Resource, max_pages: int, write: bool, **kwargs):
...
if __name__ == "__main__":
    ...
    search_videos_comments_by_keyword(service=service, max_pages=1, write=False, q='David Goggins', part='id, snippet',
                                      eventType='completed',
                                      type='video')
